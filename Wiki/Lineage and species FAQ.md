...
No. It is a fundamental design principle that orcs and humans are different with regard to spiritual roleplaying. No orc will ever become [[dedication|dedicated]], for example. There is no way that an orc character will ever be able to use the [[religious skills]] available to humans
