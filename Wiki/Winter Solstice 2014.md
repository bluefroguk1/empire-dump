...
## Overview
This page lists all the details that are specific for our fifth Empire event - the Winter Solstice 2014. There is an additional page with [[event information]] which lists arrival and departure times and similar details that are common for all Empire events.

## Battles
At the event we will be running two large battles, one Saturday morning and one Sunday morning, along with a large number of smaller encounters. The large battles will follow the normal rules for [[battles]]; you may only participate in a single battle as your character and you must monster the other battle if you decide to participate in one.
