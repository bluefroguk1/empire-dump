---
revision_id: 91525
revision_date: 2022-06-07T17:09:05Z
categories:
- Winds of Fortune
- 383YE Autumn
- Recent History
...
There are a number of legal powers that might be relevant to the title, depending on what responsibilities if any the Senate sought to give the position. The most obvious would be to make the Chamberlain a [[Senate_session#Member_of_the_Senate|Member of the Senate]], but that would require the [[Amend_powers_of_Imperial_Consul#Campaign_Outcome|removal of an existing member first]] and [[The_Throne#Ratification|ratification]].
...
This mandate will encourage citizens to seek out methods that will allow them to experience visionary dreams, whether that be rituals such as [[Dreams in the Witch House]] or [[Signs and Portents]], or potions such as [[Infusions_of_Feathers#Goosewhisper_Infusion|Goosewhisper Infusion]]. While they do so, it will be harder for the Imperial Synod to influence people with statements of principle as citizens would be seeking their own revelations rather than listening to the Synod as much. The revelations these citizens are exposed to would urge some of them to take action however - creating a number of opportunities and proposals at the Winter solstice based on their visionary experiences.
...
A further alternative is that proposed as part of the [[appraisal]] prepared by Graciana i Lopez i Guerra, detailed as part of the [[Woven_as_a_weapon#A_Five_Year_Plan|five year plan]] to encourage the faithful to use the trods to perform extended pilgrimages.
