...
## Overview
This page lists all the details that are specific for the Autumn Equinox 2015. There is an additional page with [[event information]] which lists arrival and departure times and similar details that are common for all Empire events.

## IC News
Please see the [[379YE Autumn Equinox winds of fortune]] for the latest IC developments known throughout the Empire.
For the Civil Service events set to occur and at what location, please refer to the external link to this [https://docs.google.com/spreadsheets/d/176XxhqzgZTS9jyO1poC-C0erRM66jYKdmAimKH1CB9w/edit?usp=sharing civil service timetable]
