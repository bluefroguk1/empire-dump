...
Taking PartA [[military unit]] can be assigned to take part in the raid of Skallahn by selecting ''Raid Skallahn'' from the [[Military_unit#Take_Independent_Action|independent action]] dropdown during downtime. As this a raid, in which military units are expected to spread out across the territory, enchantments that effect [[Military_unit#Take_Independent_Action|paid work]], such as [[Shroud of Mist and Shadow]] will be effective.
...
A special alternative mandate is available to the Varushkan National Assembly, should they wish to [[Blood_makes_noise#Opportunities|focus the attention of the nation on the Ossium problem]].
