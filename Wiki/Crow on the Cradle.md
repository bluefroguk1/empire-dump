...
## Overview
Since the [[Thule]] invasion of [[Karsk]] in 368YE, an independent military force has operated out of the [[Karsk#Broken Hill|Broken Hill]], in [[Karsk#Branoc|Branoc]]. Composed primarily of [[Varushka|Varushkan]] warriors apparently supported by a powerful [[Varushkan_Monster#Sovereigns|sovereign]] known as the Charnel Lord, the force was supplemented by some [[Varushkan_Monster#Wolves|Wolves]], and even a number of [[orc]] bandits. The army changed sides at least once during the war on the command of its aberrant overlord, but despite this treachery eventually came to fully support the Varushkan defenders.
...
## Significance
The Varushkan followers of the Charnel Lord represent several vales in Branoc, Crowslook and eastern [[Karsk#Nitrost|Nitrost]]. These could either form the core of a new Varushkan army or they could be used to expand an existing Varushkan army to make it [[Imperial_army#Large_Armies|large]].
...
### Supply
Sadly, the long years of war have wrought untold damage to the infrastructure of Karsk. Near constant casting of [[Rivers of Life]] means that the [[Varushkan_Roads|road]] network that connects the vales of Karsk is ruined. As a result of the devastation, the Varushkans are not currently able to [[Imperial_army#Maximum numbers of Imperial Forces|support]] a third army. After two years, the industrious Varushkans will likely repair enough of the roads to be able to support a third army if nothing else changes, but there is an opportunity to improve the situation immediately.
...
## Resolution
The Imperial Senate agreed not only to [[rebuild the roads of Karsk]], but also to [[Raise_Varushkan_army|restore the Iron Helm]]. The work on rebuilding the roads was completed shortly before the Spring Equinox 380YE.

(OOC: The cost to recreate the Iron Helms has been reduced to bring it into line with recent [[Wiki_Updates#Raising_an_Army|updates]].)