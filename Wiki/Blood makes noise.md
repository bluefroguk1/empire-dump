...
At the [[383YE_Winter_Solstice_Synod_judgements#Judgement_85|urging of Pelleas Montrose]], Dawnish knights and adventurous [[yeofolk of Dawn|yeofolk]] eager to earn [[glory]] travel across [[the Semmerlak]] to Ossium. Many stop off to visit the northern side of the [[Semmerholm#The_Golden_Causeway|Golden Causeway]], marvelling at the stories of the glorious Dawnish armies that marched across it to begin the conquest of [[the Mallum]]. They then retrace the steps of the original campaign, enthusiastically pushing into the eastern forests to fight alongside the wagon raiders. While there, many also make a pilgrimage to the [[Ossium#Tower_of_the_Scorpion|Tower of the Scorpion]] and marvel at the fact such an ugly, unwieldy eyesore caused so much harm during the liberation. When these same knights and yeofolk get to talking with some of the new Varushkans establishing their vales in the shadow of the misshapen tower, a plan begins to form. 
...
After the destruction of the Tower of the Scorpion by the Druj, Lise de Lionsgate presented a slightly ''different'' proposal, which is detailed in the [[Beyond_this_dark_house#Tower_of_the_Manticore|Beyond this dark house]] Wind of War.
...
During the coming season, there will be an additional option accessible through the [[Military_unit#Take_Independent_Action|take independent action]] dropdown menu - ''Solve the Isember problem''. The assault will be relying on overwhelming force as much as possible, striking before the bandits realise what is happening. If they can be taken by surprise, they will be too busy responding to the attack to think about their own raids.

Only [[enchantment|enchantments]] whose effects include making a military unit more effective at [[Military_unit#Take_Independent_Action|independent action]] will benefit those taking part in solving the Isember problem. In place of their normal production, any military unit assigned to the action will be able to claim some of the loot the Isemberite bandits have been stockpiling. A standard military unit without any upgrades or enchantments would expect to gain 4 measures of random forest materials, 4 ingots of random metals, and 36 rings in the form of random valuables and trade goods, with commensurately more if they have a higher strength. It is also possible that the [[Quartermaster_General_of_the_Imperial_Armies|Quartermaster General]] might choose to assign the [[Military_unit#Imperial_Guerdon|guerdon]] to the action.
...
The effect of this mandate would be twofold. First, it would cause Varushka to [[By_fountains,_by_fishes#Opting_Out|opt out]] of the raid on Skallahn detailed in [[By fountains, by fishes]]. Any military units that go on that raid will be 50% less effective, receive 50% less rewards and be unable to acquire any rare resources, but their nation will not suffer any penalty from the raid. Secondly, it will discourage Varushkan military units from taking any ''other'' options this season. This will apply the same penalty to actions including [[Military_unit#Take_Independent_Action|taking independent action]], [[Military_unit#Scout_an_Area|supporting a spy network]], or the land-based element of the [[Struggle_with_the_sea#Across_the_Borders|evacuation of Feroz]] special action. However, it will ensure that Varushkan citizens show their support for this action, and any Varushkan military unit will receive a 1 rank bonus both to their effectiveness and to the rewards they receive for taking part.
...
Following the Autumn Equinox, the [[Golden Axe]] and the armies of Dawn [[383YE_Winter_Solstice_winds_of_war#Hexwood|pressed cautiously]] into the [[Forest of Ulnak]] to the east of Ossium. Their probing advance withdrew after the Winter Solstice, but scattered camps of soldiers remained behind to explore and secure the land the armies had taken. A month after the Solstice, [[384YE_Spring_Equinox_winds_of_war#In_the_East|all those outposts fell silent]] almost simultaneously. It seemed likely that the Druj had sent a force north into the Forest of Ulnak to deal with the Imperial incursion there.
...
* [[Thousands_or_more#The_Vales_of_Ossium|Thousands or more]] - the Winter 383 Wind of Fortune that details opportunities to remove negative qualities
* [[Ossium]]