...
In times when civil service numbers in Anvil are low a citizen auxiliary has been deputised to serve as auctioneer. This has been caused in the past by the Senate requiring civil servants to  [[Employ Civil Service to observe Fleets II|observe fleet behaviour]] to prevent piracy and by [[Bloody murder|attacks on civil servants]]. However the impartial nature of the Auctioneer is a vital part of the auction, so an Agent of the Bourse will always handle the duties where possible.
### Residence
...
The Agent of the Bourse can be [[Revocation|revoked]] by the [[Assembly#General Assembly|General Assembly]], and by the [[Assembly#Assembly of the Nine|Assembly of the Nine]].
