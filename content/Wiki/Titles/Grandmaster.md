---
IgnoreLinking: False
Tags: ['Conclave', 'Conclave-order', 'Title']
Title: Grandmaster
draft: False
...
## Overview
[[Grandmaster]] is an [[Imperial Title|Imperial title]] bestowed upon a [[Magician|magician]] who is a member of a [[Conclave order]]. Each order is represented by a single [[Grandmaster|grandmaster]], which means that at this time there are seven grandmasters.
[[Grandmaster]] is a political title closely involved with the running of [[The Conclave|the Conclave]]. Grandmasters encourage members of their order to participate in [[Conclave]] affairs, and represent their order during a [[Conclave session]]. Most grandmasters also work to maintain cohesion within their order and to encourage members to pursue and advance the manifesto of the order. A strong [[Grandmaster|grandmaster]] can organise the magicians that are part of their order and help them wield political and magical power throughout [[The Empire|the Empire]].
## Responsibilities
Each [[Grandmaster|grandmaster]] is responsible for supporting the manifesto, advancing the goals, and representing the members of their [[Conclave order]]. They receive numerous political powers to allow them to do so. Their responsibility is to their order first, to the [[Imperial Conclave]] second, and to [[The Empire|the Empire]] as a whole third.
The grandmaster is also responsible for overseeing the distribution and use of the resources made available to their order. Each order receives a share of the mana from the [[Font|font]], and it is the responsibility of the grandmaster to ensure that the mana they receive on behalf of their order is used in pursuit of their order's goals. Grandmasters have been removed, and in extreme cases excommunicated for engaging in too much brazen corruption at the expense of their order.
## Powers
...
Although the grandmaster is empowered to choose how to employ their order's [[Declaration|declaration]], it remains uniquely tied to the order. The Imperial titles with the power to raise a [[Declaration|declaration]] may have their [[Proxy|proxy]] speak instead of them in Conclave, but since you legally cannot [[Proxy|proxy]] your status as a member of a [[Conclave order]], it is not possible to have a [[Proxy|proxy]] present an order declaration on your behalf. This means whoever the grandmaster chooses to submit the declaration to the [[Prefect of the Conclave]] is the only person who can be legally recognised as the person presenting the declaration. Whoever signs the writ, must present the declaration to Conclave (the only exception [[Will|will]] be where OOC reasons make this impossible).
### Veil of [[Night]]
Once per summit, if a grandmaster choses to submit their order Declaration to the Conclave agenda personally, then they can choose to invoke the Veil of Night. If they do so, they are not required to reveal any detail of a declaration: it is added to the agenda simply as "The Grandmaster of (Order) presents a declaration under the Veil of Night." The grandmaster must still provide the wording of the declaration to the Civil Service when the matter is raised to the agenda and as normal it is the precise wording presented that [[Will|will]] be discussed and voted on. After the summit, the details become public knowledge as with any other declaration.
### Power of Precedence
...
During the [[Spring]] Equinox 384YE, the [[Imperial Senate]] chose to take advantage of an [[Opportunity|opportunity]] to improve the ability of the grandmasters to purchase mana. Expansions to the mana exchanges in [[Tassato]], [[Temeschwar]], and [[Sarvos]] allow the civil service to purchase more mana without increasing the [[Cost|cost]] to the grandmaster.
### Stipend
...
A grandmaster serves for a year, until a [[Challenge|challenge]] forces their re-election, until they die or step down, or until the start of the next election. 
A grandmaster ''cannot'' be revoked by any chamber of the [[Imperial Synod]]. However, the members of an order may [[Challenge|challenge]] the grandmaster and trigger a new election. 
...
### Hustings
At an event where a grandmaster is to be re-elected, the Civil Service organises hustings immediately prior to the [[Conclave session]] on Saturday evening. The Civil Service [[Will|will]] not run emergency grandmaster elections. 
The [[Hall of Worlds]] is ceded to the order in question, and they have an allotted period of time (around half an hour) to decide their grandmaster. While members of other orders (and priests of the [[Imperial Synod]] exercising the right of [[Witness|witness]]) can attend the meeting they cannot speak, and the civil service [[Will|will]] exclude anyone who attempts to interrupt the proceedings.
...
### Incumbent
The current grandmasters are listed below - see the individual order pages for a full election [[History|history]] for each position.
