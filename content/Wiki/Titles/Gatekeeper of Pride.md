---
revision_id: 97051
revision_date: 2023-01-26T15:48:33Z
Tags:
- Title
draft: false
Title: Gatekeeper of Pride
aliases:
- Gatekeeper_of_Pride
---
## Overview
...
## Responsibilities
The [[Gatekeeper of Pride]], along with the other six gatekeepers, are responsible for determining who receives the precious, and limited supply of true liao. They are expected to choose someone of obvious virtue to receive each dose. Normally, a dose of true liao is used to experience a past life vision, but there are several other uses to which it can be put. Regardless of the wishes of the gatekeepers, the law is crystal clear. The gift of true liao is a reward from the Synod for virtuous behaviour, and the recipient is free to put it to any legal use they wish.
...
## Appointment
The [[Gatekeeper of Pride]] is [[Cardinal#Appoint the Gatekeeper|appointed]] by the [[Cardinal of Pride]]. The Gatekeeper must be a member of the Pride Assembly. Unlike many titles, if a new [[Cardinal|cardinal]] is appointed they may immediately reappoint the appropriate gatekeeper.
...
The [[Gatekeeper of Pride]] can be [[Revocation|revoked]] by the [[Assembly#General Assembly|General Assembly]], and by the [[Assembly#The Virtue Assemblies|Pride Assembly]].
RecentElections|Gatekeeper_of_Pride