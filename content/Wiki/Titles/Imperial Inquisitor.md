...
## Overview
This [[Imperial Title|Imperial title]] was established by vote of [[The Senate|the Senate]] in [[Spring]] 378YE. The holder is responsible for coordinating and overseeing [[Inquisition|inquisition]] in [[The Empire|the Empire]] working with the Imperial Militia to ensure inquisitions occur correctly within [[The Empire|the Empire]]. Although the title holder has no power to limit or direct the use of [[Inquisition]] by [[The Synod|the Synod]] they do have the power to carry out an inquisition in their own name.
## Responsibilities
...
To use this power, the Imperial Inquisitor must still place a [[Judgement|judgement]] before the Synod, but it is considered to pass automatically at the point it is presented.
## [[Appointment]]
