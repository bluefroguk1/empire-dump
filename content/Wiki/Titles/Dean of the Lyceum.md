...
OOC Note: The Dean selects the arcane projection they wish to formulate by e-mail to Profound Decisions (rules@profounddecisions.co.uk) prior to the next event. The final magnitude of the ritual text is not guaranteed to be the same as that of the arcane projection.
