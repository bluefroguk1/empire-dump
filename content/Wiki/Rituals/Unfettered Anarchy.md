---
revision_id: 93900
revision_date: 2022-07-26T21:19:23Z
Tags:
- Rituals
- Night-Ritual
draft: false
...
In addition, the target ''cannot'' use [[Heroic skills#Hero points|hero points]] or similar sources of [[Roleplaying effects#Spiritual strength|spiritual strength]] to overcome the [[Roleplaying effects|roleplaying effect]] created by this curse. They may overcome ''other'' roleplaying effects using the normal rules. 
Season Duration
### Removing the Curse
The ritual [[Crystal Clarity of the Rational Soul]] is frequently used to counter the effect of ''[[Unfettered Anarchy]]''. The effect of that [[Enchantment|enchantment]] replaces, but does not remove, any other roleplaying effect the target is currently experiencing - meaning that for as long as the [[Enchantment|enchantment]] persists the target feels calm and relaxed (as per the description of that [[Enchantment|enchantment]]). When that enchantment ends, any other auras that the character is experiencing resume, assuming they have not expired.
## Description
