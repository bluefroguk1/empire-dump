---
revision_id: 90037
revision_date: 2022-05-12T14:08:07Z
Tags:
- Winter-Ritual
- Rituals
draft: false
...
The target experiences a [[Roleplaying effects|roleplaying effect]]; the target finds it increasingly difficult to care about injuries that are not incapacitating, and often forgets to seek out healing unless reminded to do so.
Season Duration
### Additional Targets
This ritual can affect additional characters from the same [[Groups#Banners|banner]]. Each additional character increases the magnitude by 7. Additional characters must be present throughout.
## Description
