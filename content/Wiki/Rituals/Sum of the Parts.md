...
Day Duration
### Additional Targets
This ritual can affect additional characters from the same banner. Each additional character increases the magnitude by 10 and will require an additional three participants to sacrifice a global hit. Additional characters must be present throughout.
## Description
