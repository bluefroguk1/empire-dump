...
A [[Mark of Agramant]] can be detected by a [[Detect Magic]] spell cast on the character for that ''specific purpose'' (a detect [[Magic]] spell cast for any other purpose does not reveal the mark). If the caster of the Detect detect magic also bears a Mark of mark of Agramant then they discover that their marks are the same; otherwise they discover nothing.
The Mark of mark of Agramant is not restricted to any part of the target's body; it cannot be hidden from detection by covering it up.
