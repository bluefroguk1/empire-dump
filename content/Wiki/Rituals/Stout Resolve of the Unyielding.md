...
- Rituals
draft: false
Title: Stout Resolve of the Unyielding
aliases:
...
### Effects
The target may ignore the effects of a single traumatic wound that is affecting them, until the end of the battle. The traumatic wound is still present, and can be healed as normal, but the target only suffers its penalties after the [[Enchantment|enchantment]] ends.
