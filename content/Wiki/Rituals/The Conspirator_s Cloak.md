...
[[Enchantment|enchantment]] This is also a personal [[Aura]]. A target may only be under the effect of one personal aura at a time.
### Effects
...
This [[Enchantment|enchantment]] is a personal [[Aura]], similar to that created using the anointing ceremony. A character can only be under one aura at a time. This ritual will replace any standard personal aura (including those created by similar [[Rituals|rituals]]), but is not powerful enough to remove a personal aura with a [[Aura#Strong Auras|strength]] higher than one. Likewise, any anointing can replace (or remove) this [[Enchantment|enchantment]]. A [[Detect Magic]] spell determines the realm and magnitude of the effect, but the [[Insight]] skill will not detect any spiritual component to the enchantment.
Season Duration
### Additional Targets
...
The ritual can be made permanent with [[Ilium#Using Ilium in Rituals|ilium]]; magicians and priests alike who have studied this ritual (and [[Chamber of Pallas|similar enchantments]], speculate that as an [[Ilium|ilium]]-infused enchantment it would require [[Liao#True Liao|true liao]] to remove the enchantment with an anointing. Access to true liao is limited, however, and so far no-one has attempted to do this.
## Common Elements
