...
enchantment
### Effects
The ritual enchants the entire Empire flooding every Imperial Territory with energy drawn from the Night [[Realm]]. The precise effects of this flood of [[Magic]] are unpredictable, but will always create certain effects. 
Firstly, every Forest in [[The Empire]] will produce two additional measures of special material over the next season which match the base production chosen when the forest was created.
