...
In addition, while under the curse the target is under the effect of [[Weakness|WEAKNESS]]. This [[Weakness|weakness]] cannot be removed by any means as long as the curse remains in effect. Any resources used to try and remove the weakness are consumed without effect.
Year Duration
### Removing the Curse
