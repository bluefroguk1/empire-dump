...
[[Enchantment]]
Paid work and independent actionNote that the additional production ''only'' applies to a military unit specifically taking the paid work action, not to every action under the ''independent action'' dropdown.
### Effects
...
### Performing the Ritual
Casting time|10 Imperial Reduction
Regio|Autumn This ritual targets a Fortification, and must be performed in a strong Autumn Regio in the Territory containing the fortification. If the territory is part of the Empire, then it may instead be performed from the Imperial regio. 
Enchantment
### Effects
