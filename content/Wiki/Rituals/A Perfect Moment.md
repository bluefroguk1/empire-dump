...
Further complicating the codification, a significant stumbling block in the shape of [[The Law|the Law]] of Scale reared its head. The professors of the Halls of Knowledge discovered that the transitory nature of an enchantment based on an [[Arcane projection|arcane projection]] with a short-lived duration was incompatible with the subtle magics of a [[Formulaic ritual|formulaic ritual]]. While the magic could have been formulated with a daily duration, it would have been the exact same magnitude as an enchantment that lasts for a season. After much discussion, the decision was taken to simply follow the path of least resistance and codify the ritual with a season duration.
