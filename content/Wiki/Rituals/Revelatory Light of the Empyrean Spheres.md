...
### Effects
This [[Enchantment|enchantment]] allows the target to call [[Calls#Mass Calls|MASS]] [[Calls#PARALYSE|PARALYSE]] once during the duration. The character must be able to cast spells to make this call - it explicitly will not work if they are wearing armour. 
