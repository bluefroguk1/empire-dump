---
revision_id: 93368
revision_date: 2022-07-20T10:21:31Z
Tags:
- Rituals
- Night-Ritual
draft: false
...
Casting time|2 Target Character The target character must be willing. The ritual must be performed near the [[Sentinel Gate]] when it is performed in Anvil, or near the gate's return point if it is performed elsewhere.
...
## Common Elements
Even though the ritual only requires ''guising'' the target if it is of a different species to the magicians performing it, it is common to include that element even when the species is the same. Another common element is the use of hearth magics related to identity such as [[Dawn hearth magic#Girding|girding]], [[The League hearth magic#Masks|masks]], [[The League hearth magic#Mirrors|mirrors]], [[Highguard culture and customs#The cowl|cowls and veils]] or [[The Brass Coast hearth magic#Clothing|donations of clothing]]. Similarly, symbolic ceremonies of adoption or marriage might be employed, often followed by an equally symbolic casting-out or divorce once the gate is passed. A [[Wintermark|Kallavesi]] involved in designing the ritual suggested that certain [[Wintermark hearth magic#Animals and Masks|animal masks]] might also be appropriate - symbolically casting the subject as an animal companion rather than a member of the same nation.
The [[Astronomancy|constellation]] of [[The Three Sisters]] is quite appropriate to this ritual, as are the runes of [[Diras|mystery]] or [[Queros|plots]]. [[Dramaturgy|Dramaturgical]] performances using [[The Witch]], especially those involving cases of mistaken or concealed identity, are also a good fit for this magical glamour.