...
Title: Thief_s Arcane Gambit
aliases: ["Thief's_Arcane_Gambit"]
draft: False
revision_date: 2023-08-03 23:09:09+00:00
revision_id: 104261
---
...
Casting time|2 The character or item bearing the target [[Enchantment|enchantment]], as well as the character or item intended to receive the [[Enchantment|enchantment]], must be present throughout.
### Effects
...
The ritual ''can'' be used to transfer enchantments such as [[Blessing of New Spring]] which target a [[Resource|resource]] but use a character as the focus for that ritual. This is much more prone to failure, however, as it is difficult to be certain about the magnitude of the target enchantment, or be certain what the targeting restrictions are.
### Additional Magnitude
You may increase the magnitude of the ritual to attempt to target a more powerful enchantment.
### OOC Note
Despite similar terminology, the qualities of a [[Magic|magic]] item are not enchantments. They are an innate part of the item - it is impossible to move the magical properties of a [[Magic|magic]] item to another magic item using this ritual.
## Description
Misdirection, cleverness, cunning and transformation ... in this case these all boil down to the ability to take something from one place and move it to another. Often this ritual is used for quite legitimate purposes - to move an enchantment to a new target who [[Will|will]] benefit from it, with the collusion and approval of the donor character. Other times, the enchantment is moved for underhand reasons - effectively stolen from a legitimate target and placed on someone undeserving. [[The Law|The law]] is not entirely clear on whether this counts as theft or not; often the [[Imperial Conclave]] is called on to determine if a theft has taken place. It is more common for an unwilling target to be a restrained [[Barbarian|barbarian]] or prisoner of [[War|war]], but it is also possible to use trickery to cause the bearer of the target enchantment to remain unaware of the true purpose of the ritual - an apocryphal tale speaks of a Marcher ritualist who persuaded a spy to receive what she believed was a ritual to [[Purge|purge]] [[Venom|venom]] when in fact the clever Bregaslander used ''Thief's Arcane Gambit'' to transfer [[Secrets of the Empty Heart]] from the spy to himself before handing the spy over to the [[Magistrates|magistrates]] for interrogation.
...
## Common Elements
This ritual often involves symbolic transfer of something from the donor to the recipient. For example, in a consensual ritual the donor might hand a token or item associated with the enchantment to the new target. In less consensual uses, the target may be stripped of valuables, especially items of jewelry, which are then given to the recipient character. For the [[Navarr]], blood is often shared between two [[Characters|characters]] affected by the ritual, or the same design traded on both [[Characters|characters]] or items. When [[Runes|runes]] are used, the same [[Runes|runes]] are [[Painted|painted]] on both the target with the enchantment and the target who will receive it. Commonly the [[Rune|rune]] [[Xun]] is used.
