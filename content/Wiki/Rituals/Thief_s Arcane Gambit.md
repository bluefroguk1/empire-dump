...
### Effects
This ritual targets an [[Enchantment]] on a character or item. At the completion of the ritual, the [[Enchantment|enchantment]] is moved from the character or item it is on now to a new character or item (as appropriate).
...
### OOC Note
Despite similar terminology, the qualities of a [[Game items#Magical Items|magic item]] are not enchantments. They are an innate part of the item - it is impossible to move the magical properties of a magic item to another magic item using this ritual.
## Description
