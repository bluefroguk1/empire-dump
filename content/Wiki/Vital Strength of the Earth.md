---
revision_id: 98175
revision_date: 2023-03-09T15:18:38Z
categories:
- Summer Ritual
- Rituals
aliases:
...
### Effects
When the enchanted character uses the [[Heroic skills#Unstoppable|unstoppable]] skill they regain up to 5 hits (rather than the usual three). When they use the [[Heroic skills#Relentless|relentless]] skill they repair all limbs that have been ruined by the [[Calls#CLEAVE|cleave]] or [[Calls#IMPALE|impale]] call rather than just one. Whenever they use either ability they they are also cured of the [[Calls#VENOM|VENOM]] status if they were affected although this effect will not work if the [[purify]] spell would fail to remove the VENOM effect for any reason.
...
### Additional Targets
This ritual can affect additional characters from the same [[Groups#Banners|banner]]. Every two additional characters increases the magnitude by 24. Additional characters must be present throughout.
...
There are a few side notes that the runes [[Verys]] and perhaps also [[Bravash]] resonate with the ritual. Evocation of the names of [[Adamant]] (obviously) and [[Cathan Canae]]; [[Totem_magic#Heraldic_Magic|heraldic magicians]] might find the [[Legendary_beasts#Mandowla|mandowla]] or the [[Legendary_beasts#Hydra|hydra]] support the enchantment.
