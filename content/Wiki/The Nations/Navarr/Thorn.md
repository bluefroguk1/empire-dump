...
## Thornborn
It is rare that a problem can be solved by a single Thorn; cooperation between many Thorns is usually required to defeat an enemy. The Thorns in a large [[Steading]] or [[Striding]] [[Will|will]] usually [[Fight|fight]] together, alongside the other warriors from the community. But when preparing for battle, lone Thorns from smaller communities often band together under a single [[Banner|banner]].
