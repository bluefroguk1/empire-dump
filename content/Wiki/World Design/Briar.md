...
## Iconic trapping
Each lineage has an iconic trapping; in the case of the briar it is patches of bark on the skin. Bark is the most common physical mark for lineaged characters but they are not a required element. If you do not have the iconic trapping, however, you ''must'' have at least one of the other physical trappings associated with the briar lineage. 
### Patches of bark
...
## Other trappings
In addition to patches of bark there are a number of physical trappings that mark someone as being of the Briar lineage. If you want to phys-rep one of the trappings with a slightly different technique or style to the ideas suggested here then that is absolutely fine. If you want to use different trappings to the ones listed then you should [mailto:matt@profounddecisions.co.uk email us].
### Green eyes
...
anchor|overwhelmed
Briars may be overwhelmed by the Spring Spring realm
...
Note that this boon applies ''only'' to roleplaying effects; it does not allow one to ignore supernatural effects such as that inflicted by the [[Weakness]] spell. 
## Briar Life
Anchor|The Blood
### Briar Children
...
* The Navarr are especially suspicious of the briars, seeing a connection between them and The [[The Vallorn]]. 
...
The handmaidens of the [[Eternal]] Yaw'nagrah have been known to provide ''fruit of [[The Oak]]'' to mortals in the past that, when consumed, can grant the eater the briar lineage. Convincing the ''Green Mother'' to grant one of the rare fruits is said to be a difficult task, made all the more difficult by the [[Declaration]] of Enmity against the eternal.
