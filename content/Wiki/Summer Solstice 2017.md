...
## Overview
This page lists all the details that are specific for the Summer Solstice 2017. There is an additional page with [[event information]] which lists arrival and departure times and similar details that are common for all Empire events.

## IC News
Please see the [[381YE Summer Solstice winds of fortune]] for the latest IC developments known throughout the Empire.  An [[Event schedule]] that shows timings of IC activities common to all Empire events is also available.
A list of what Imperial elections are taking place this event can be found [[381YE_Summer_Solstice_Imperial_elections | here]]
