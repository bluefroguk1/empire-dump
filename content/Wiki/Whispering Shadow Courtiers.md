...
### Performing the Ritual
 During the ritual the contributors must whisper a secret of some sort, preferably one unknown to the other contributors.
...
### OOC Elements
Anyone who performs this ritual will be left with a scroll - a physical communication from the Whisper Gallery. This scroll also represents a pact with the eternals, allowing the bearer to send a return communication using the [[operate portal]] spell at the [[Regio#The_Imperial_Regio|Imperial Regio]]. This ability can only be used at night. It needs a written document, and the presence of one of the scrolls received from this ritual. Both are handed to a referee as the operate portal spell is cast.

## Description
As of Winter 379YE, it is illegal to perform this ritual in the Empire as the Whisper Gallery - the eternals on whose power it explicitly draws - are under [[Amity_and_enmity#Enmity|enmity]].
