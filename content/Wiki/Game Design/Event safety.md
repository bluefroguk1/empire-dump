...
If a weapon checker approves an item then they will attach a coloured elastic band to the item. We change the colour of the elastic [[Bands|bands]] for each event. You must not use any item for melee purposes unless you know it has been approved for that use.
