...
Our [[Bow safety|bow safety]] rules prohibit the use of bows and crossbows after "dusk". At this event we are defining that point as 19:30 each [[Day|day]]. This means you cannot use a bow in [[Anvil]] after this time, or on a skirmish or quest that starts after this time.
The necromantic [[Ritual|ritual]] [[Whispers through the Black Gate]] can only be performed for one hour around dusk - at this event that means the ritual can be performed at any time between 19:00 and 20:00.
## Toilets
