...
* The names of [[Rituals|rituals]], potions, and items are unique and are capitalised using title style. Spells, [[Herbs|herbs]], and [[Skills|skills]] are [[General|general]] and common and are not capitalised. e.g., it is [[Ascetic Star of Atun]]; [[The Sovereign]] Specific; [[Biting Blade]]; [[Heal|heal]]; [[True Vervain|true vervain]]; and [[Magician|magician]].
...
* The bay south of [[The Empire|the Empire]] is the [[Bay of Catazar]] with no double letters (but note that the adjective is Catazarri)
...
IC and OOC should be written in full as in-character or out-of-character, not abbreviated. In [[General|general]] [[The wiki|the wiki]] should avoid abbreviations, even where they are common use in LRP. The aim is to ensure that [[The wiki|the wiki]] stays as readable as possible by people who are new to LRP.
## Uploading content
