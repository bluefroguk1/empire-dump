...
## IC News
See the 384YE Winter Solstice [[Winds of Fortune]] and the winds of [[War]] for all the latest in-character developments throughout [[The Empire]]. An event schedule that shows timings of IC activities common to all Empire events is also available. There is also a list of upcoming [[Imperial Elections]]
## Battles
...
Our bow safety rules prohibit the use of bows and crossbows after "dusk". At this event we are defining that point as 20:45 each day. This means you cannot use a bow in Anvil after this time, or on a skirmish or quest that starts after this time.
