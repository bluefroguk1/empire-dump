...
## Overview
This page lists all the details that are specific for the [[Spring Equinox 2015]]. There is an additional page with [[Event Information]] which lists arrival and departure times and similar details that are common for all Empire [[Events]].
## IC News
Please see the 379YE Spring Equinox [[Winds of Fortune]] and 379YE Spring Equinox winds of [[War]] for the latest IC developments known throughout [[The Empire]].
For the Civil Service events set to occur and at what location, please refer to the external link to this [https://docs.google.com/spreadsheets/d/1yltejfcbTCXSZSu7Sp8IVW8vOatLRPsMbkl3chGQjs4/edit#gid=1105747951 civil service timetable]
## Battles
