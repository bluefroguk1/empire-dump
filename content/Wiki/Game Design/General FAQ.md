...
We are quite explicitly setting out to make assassination as difficult to achieve as possible. [[The Empire]] has a legal system, run by NPCs, and it [[Will|will]] make all possible effort to identify and execute assassins. Our intention is for the majority of conflict between players to be political and social in nature rather than combat based.
...
It is not possible for [[The Empire|the Empire]] to create monsters for their own use on [[The Battlefield|the battlefield]].
...
The most important principle is stylistic. Empire is about the players being [[Heroes|heroes]] - it's about them battling against terrible monsters. It's not a game about hatching terrible monsters that go off and do the fighting for you and wipe the enemy out so you don't have to bother. We want players to feel like the most important characters on [[The Battlefield|the battlefield]], not to feel like they're here to make up the numbers while their monster kills all the orcs. In essence we're not prepared to countenace even the possibility that players end up as third spear-carrier from the left as their monster rules [[The Battlefield|the battlefield]].
For all these reasons we don't support any options for [[The Empire|the Empire]] to have monsters on [[The Battlefield|the battlefield]] and [[The setting|the setting]] is deliberately written to make it impossible for [[The Empire|the Empire]] to field them ([[The Sentinel|the Sentinel]] [[Gate]] does not allow them to pass through).
...
You can advertise services and products in our Facebook [[Groups|groups]] and forums that you [[Will|will]] have for sale, provided that you state your price. Haggling or negotiation over prices must be left to the field.
...
### Do I have to phase out my less appropriate [[Costume|costume]]?
