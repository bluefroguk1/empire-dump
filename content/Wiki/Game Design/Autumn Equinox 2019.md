...
The winds of [[War|war]] now provides information about the battle [[Opportunities|opportunities]] at the forthcoming event, along with information on the the best estimate of the fighting strength of each nation provided by the civil service is as follows that determines which nations can take [[The Battlefield|the battlefield]] together. 
## Toilets
...
The two main [[Accessibility|accessibility]] camps (shown with the larger symbol) each have a disabled toilet within10m of the camp. There is no disabled toilet at the third camp (shown with a smaller symbol). 
