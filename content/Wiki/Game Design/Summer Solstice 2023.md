...
## IC News
See the 385YE Summer Solstice [[Winds of Fortune]] and the winds of [[War]] for all the latest in-character developments throughout [[The Empire]]. An event schedule that shows timings of IC activities common to all Empire events is also available. There is also a list of upcoming [[Imperial Elections]]
...
## Traders
The following traders are already booked for the event. We anticipate that the majority of our traders who booked for the [[Spring Equinox 2023]] will book for the Summer Solstice. 
