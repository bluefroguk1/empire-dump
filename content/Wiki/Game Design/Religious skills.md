...
A starting congregation resource produces five doses of liao per event, and also allows a character to participate in the [[Business|business]] of the [[Imperial Synod]] - the political body that guides the Empire on spiritual matters.
The Seven Virtues
[[Ambition]]
[[Courage]]
[[Loyalty]]
...
While there are some exceptions, performing a ceremony requires a dose of liao and ten seconds of [[Appropriate roleplaying|appropriate roleplaying]]. Some ceremonies also require the presence of a [[Referee|referee]]. Individual skills may call out exceptions to these rules (such as the ability to perform a quick [[Insight]]).
The target of a religious skill must usually be close enough to touch, and present throughout.
If you are using a skill that creates an [[Aura|aura]], you need to specify which [[Aura|aura]] you are creating. For example, there are four personal auras that a priest dedicated to Ambition can create with anointing. They must tell the target of the anointing which aura they have imbued.
