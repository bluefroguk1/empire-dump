...
## Overview
This page lists all the details that are specific for our fifth Empire event - the [[Winter Solstice 2014]]. There is an additional page with [[Event Information]] which lists arrival and departure times and similar details that are common for all Empire [[Events|events]].
## [[Battles]]
At the event we [[Will|will]] be running two large [[Battles|battles]], one Saturday morning and one Sunday morning, along with a large number of smaller encounters. The large battles [[Will|will]] follow the normal rules for Battles; you may only participate in a single battle as your character and you must monster the other battle if you decide to participate in one.
...
### Volunteering
Players are welcome to volunteer to help PD crew the smaller encounters, but are not obliged to do so - anyone who volunteers to help by [[Monstering|monstering]] an encounter will receive a token that enables you to collect a free drink from the bar as thanks.
## Site Map
