...
The wiki is a living document that details the rules and setting of [[The Empire|the Empire]] game. It contains information about [[The Empire|the Empire]] itself, its neighbours, and the world in which it exists. It also records important game information such as the properties of [[Magic Items|magic items]], the know [[Rituals|rituals]] of [[Imperial lore]], and the religious ceremonies used by priests as well as the actual rules of [[The game|the game]] itself. While it can appear daunting at first, it's not intended that anyone should memorize it, or even read all of it.
Unlike many wikis such as [https://www.wikipedia.org/ Wikipedia], [[The Empire|the Empire]] wiki is not public access. It's primarily written and maintained by the game team, with a number of player volunteers who help maintain quality and identify errors and inconsistencies. 
## The Search Function
...
## Truth
 ...
 Where things are more vague, and may or may not be true, the wiki [[Will|will]] highlight this with phrases like "many historians believe" - in these circumstances we are intentionally leaving it vague.
...
## Winds
As well as helping lay the foundations for the game, parts of the wiki are dynamic and change over time - the wiki also chronicles the campaign and the player actions that shape it. The best examples of this are the Winds of [[War]] and the [[Winds of Fortune]]. Before every event, the game team updates the Recent [[History|history]] page. The Winds of [[War]] recount the [[Events|events]] and outcomes of [[The Empire|the Empire]]'s military campaigns against their enemies. The [[Winds of Fortune]] lay out [[Opportunities|opportunities]], challenges, and [[Events|events]] that have happened since the end of the previous event and are relevant to the coming summit.
These two [[Groups|groups]] of pages combine in-character information and out-of-character information. For example, a Wind of [[War]] [[Will|will]] begin with a narrative that explains what has happened in-character during a given season, and be followed by a short game information section that explains what that means in out-of-character terms such as whether a [[Territory|territory]] has changed hands or if there is an [[Opportunity|opportunity]] for players to have their [[Characters|characters]] directly affected by the [[Events|events]]. Likewise, the [[Winds of Fortune]] are usually laid out in in-character [[Language|language]], with sections explaining what this means from a game mechanical point of view.
...
* Read the bits that are relevant to your character - if you're a [[Ritual|ritual]] spellcaster you should know how [[Rituals|rituals]] work for example.
