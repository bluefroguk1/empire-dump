...
## Overview
This page lists all the details that are specific for the [[Winter Solstice 2016]]. There is an additional page with [[Event Information]] which lists arrival and departure times and similar details that are common for all Empire [[Events]].
## IC News
Please see the 379YE Winter Solstice [[Winds of Fortune]] for the latest IC developments known throughout [[The Empire]].
For the Civil Service events set to occur and at what location, please refer to the external link to this [https://docs.google.com/spreadsheets/d/1poP75Iomi79sizyC1Sm8gCHumP7S7nhXWudb-PdcP7M/edit?usp=sharing|Civil Service Timetable]
## Battles
