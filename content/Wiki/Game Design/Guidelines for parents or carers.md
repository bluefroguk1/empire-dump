...
It is fine to take them on any plot that is marked "Combat Unlikely or Contained", but you must check the other accessibility elements of the plot to make a decision if it's appropriate. Sometimes plots are very high tension/gore/fear even though they have no combat. Some young children won't be affected and some could find that distressing. You will need to make a judgement based on the information of what's appropriate for your child but it's not possible for us to scale plots back as the point is to provide a sense of risk/threat for adults for whom combat is inaccessible.
