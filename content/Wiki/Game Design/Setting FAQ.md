...
## Introduction
FAQ
This section of the FAQ contains questions about the Setting. For questions about other parts of the game, please see the FAQ.
## Geography
...
True Liao visions are run as “encounters” during the events. No one should claim to have taken true Liao in their background.
...
The civil service only records details of characters with congregations for purposes of determining membership of the Imperial Synod. Their skills, including Dedication (if any) are irrelevant. The civil service have no way to detect that a character is dedicated to something other than one of the seven virtues of the Way - so a character dedicated to a "false virtue" who has a congregation personal resource would begin as part of the Assembly of the Way, but could then use the preaching action in downtime to become a member of any of the eight Virtue Assemblies just like any other priest.
