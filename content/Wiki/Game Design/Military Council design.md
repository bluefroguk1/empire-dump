...
This projection is provided by the civil service to the generals at each event they attend, based on scouting reports, military analysis and predictions made using day and Night [[Night magic]]. The generals are told what outcome is going to happen if they do not intervene in anyway.
