...
## IC News
See the 385YE Spring Equinox [[Winds of Fortune]] and the winds of [[War]] for all the latest in-character developments throughout [[The Empire]]. An event schedule that shows timings of IC activities common to all Empire events is also available. There is also a list of upcoming [[Imperial Elections]]
## Battles
...
Our bow safety rules prohibit the use of bows and crossbows after "dusk". At this event we are defining that point as 21:45 each day. This means you cannot use a bow in Anvil after this time, or on a skirmish or quest that starts after this time.
...
## Traders
The following traders are already booked for the event. We anticipate that the majority of our traders who booked for the [[Winter Solstice 2023]] will book for the Spring Equinox. 
