...
## Overview
This page lists all the details that are specific for the Spring Equinox 2016. There is an additional page with [[event information]] which lists arrival and departure times and similar details that are common for all Empire events.

## IC News
Please see the [[380YE Spring Equinox winds of fortune]] for the latest IC developments known throughout the Empire.

For a list of what official elections are due to take place refer to the [[380YE Spring Equinox Imperial elections]] page

For the Civil Service events set to occur and at what location, please refer to the external link to this [https://docs.google.com/spreadsheets/d/1xn51MI8xFIbAJHDtBIxSWTaM9GtigV1r-osJbDlt1vM/edit#gid=1105747951]
