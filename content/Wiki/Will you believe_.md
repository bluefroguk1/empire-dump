---
revision_id: 85555
revision_date: 2022-01-21T21:32:30Z
categories:
- Winds of Fortune
- 382YE Winter
- Recent History
...
## The True Way
The [[Sumaah Republic]] has never denied that the Empire helped them find [[the Way]]. What they increasingly take issue with, however, is the idea that they should look to [[Bastion#The White City|Bastion]] and the [[Imperial Synod]] for guidance.

They recognise the same Virtues as Imperial priests; study the same [[Religious skills|ceremonies]]; harvest [[liao]]; explore the mysteries of [[liao#True Liao|true liao]]; look to the same [[The_Doctrines_of_the_Faith|doctrines]]; debate the nature of [[The_Labyrinth_of_Ages_and_the_Paragons_and_Exemplars|the Labyrinth]], the [[paragons and exemplars]], and the Creator just as much as their peers in the Empire do.
...
As a result Sumaah missionaries have spread out across the world - including [[Silver_clouds_with_grey_linings#Missionaries_to_the_Empire|to the Empire]]. These devout followers of the Way preach in ports along the southern coast of the Empire. They expound upon the doctrines of the Way and the tenets of the virtues both publicly and in private meetings with citizens interested in what they have to say. In addition to their sermons on the importance of orthodoxy, and of denouncing and opposing [[Religious_crime#Blasphemy|blasphemy]], [[Religious_crime#Heresy|heresy]], and [[Religious_crime#Idolatry|idolatry]], they have repeatedly denounced the Imperial Synod, claiming that the [[Assembly#The Virtue Assemblies|Virtue assemblies]] in particular have allowed political expediency to blind them to the true path of Virtue.

They point to a number of clear examples of this - the presence of the [[Feroz#The_Temple_of_Balo_and_the_Black_Bull|Temple of Balo and the Black Bull]] in [[Feroz]] for example. The [[Lorenzo's_Legacy#The_Legacy_of_Loyalty|shrines]] to the [[Asavean Archipelago|Asavean]] false-god of magic dotted around [[Tassato]]. They describe the recent [[Schisms_and_Heresies#The_Yaelian_Schism|Yaelian Schism]] that nearly tore the Empire apart; the insistence in declaring [[orc|orcs]] to be paragons and exemplars despite the many questions still unanswered about their souls and the clear doctrinal issues with placing a non-human in a place of authority over a human soul; and point to tacit approval of [[Mournwold#Whittle|hate]] and [[Great_Forest_Orcs#The_Briars|anarchy]] and [[Faraden|vengeance]]. Their most serious concerns are for Imperial citizens who they say practice blasphemy in place of true religion; with nearly four hundred years of tolerance for ancestor reverence, and non-doctrinal spiritual beliefs be they magical dances, superstitious nets, [[glory]], [[Love in Dawn|love]], and whatever it is the priests of the [[The_Marches_religious_beliefs|Marches]] preach.
...
### Hinder Us Not
Severin von Holberg has submitted an [[Mandate#Alternative Mandates|alternative mandate]]
...
Benedict Pacelli Von Holberg has submitted an [[Mandate#Alternative Mandates|alternative mandate]]
...
If this mandate passes, the implication is that from that point onward the [[The Doctrines of the Faith|doctrines of the faith]] would begin to diverge - there would be no expectation that doctrinal changes in the Empire would be reflected in Sumaah, nor vice versa. The understanding of the Virtues might also diverge - again with no requirement for either faith to acknowledge the changes of the others unless they proved to be egregious subversion in some fashion.
...
As with all such complex international and religious situations, there are any number of possible approaches not mentioned here. In addition to [[Mandate#Alternative_Mandates|alternative mandates]] for example strongly worded [[statement of principle|statements of principle]], or even [[change of doctrine]] might improve (or worsen) the situation
...
## Competing Mandates
The mandates detailed under [[#Appeasment|Appeasement]] and [[#Refutation|Refutation]] compete with each other. The mandate detailed in appeasment competes with both mandates detailed under [[#Closer to Home|Closer to Home]].
 
Only mandates are in opposition - if the writ of excommunication detailed in [[#An Extreme Solution|An Extreme Solution]] is passed with a greater majority it does not compete with the former mandates but will  likely supersede them.
...
The Synod could choose to enact none of these mandates. The Sumaah will, if nothing else changes, continue to preach against the Imperial Synod in the Empire and abroad. While it is difficult to predict how much influence the Sumaah may bring to bear outside the Empire they have already encouraged the [[Principalities of Jarm|Jarmish]] Magician-Prince of Limitu to close the [[Limitu Principality House of the Way]]. While this is a minor thing, an occurred in a nation with only minimal interest in the Way, it still represents a victory for Timoj and a loss for Bastion.

More significant are the missionaries preaching in the Empire. If they are left to their own devices, there will be a small but noticable loss in support for the Synod in some of the nations along the Bay of Catazar. The impact will be felt most strongly in those nations already given to a certain level of orthodoxy - specifically [[the League]] and [[Highguard]] - or those already predisposed to question the Synod - such as Urizen whose recent support for the [[sword scholar]] philosophy is very much in line with looking askance at the unquestionable authority of the [[Assembly|assemblies]]. As a consequence every [[congregation]] in [[Sarvos]], [[Tassato]], [[Redoubt]], [[Spiral]], and [[Necropolis]] will provide 1 less liao and 2 fewer votes in the Synod by the start of the Spring Equinox.

If the Sumaah missionaries continue to have unimpeded access to the Empire over the long term, then it will become increasingly difficult for the Synod to move the hearts and minds of people they interact with (with [[statement of principle|statements]] or [[mandate|mandates]]).

Any of the mandates detailed under [[#Appeasment|Appeasement]], [[#Refutation|Refutation]], or [[#Closer to Home|Closer to Home]] (with the exception of [[Will_you_believe%3F#Challenge|challenge]]), or the [[#An Extreme Solution|excommunicaton of the Summah houses of virtue]] will prevent the reduction in congregation strength at least until the start of the Spring Equinox. The exact outcome depends on the response of the Sumaah to the Synod's judgement.
...
## Resolution
During the Winter Solstice several [[mandate|mandates]] were brought before the [[Imperial Synod]]. Erasmo di Tassato proposed [[#Appeasement|appeasement]]; Solas of Urizen declared that the Way was [[#Not_Bound_To_The_Empire|not bound to the Empire]]; Ephron of Adina's Charge declared that faith was [[#Not_a_Trickle.2C_But_a_Flood|Not a trickle but a flood]]; and Severin von Holberg declared that the Sumaah should [[##Hinder_Us_Not|hinder us not]]. All were defeated or withdrawn at the request of the raising priest. In the end the Imperial Synod supported the mandate presented by Jorma Steelhail - urging the Empire and Sumaah to [[#A_Sea_of_Savagery|seek common ground]]. If Jorma enacts the mandate, it will be up to the Sumaah how they wish to respond.

Regardless, the missionaries of Sumaah continue to encourage the people of the Empire to [[#Doing Nothing|question the Synod]].