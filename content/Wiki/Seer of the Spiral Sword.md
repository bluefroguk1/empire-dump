---
revision_id: 81167
revision_date: 2020-08-16T10:27:43Z
categories:
- Bourse
- Title
aliases:
...
## Overview
The Seer of the Sword is an [[Imperial title]] appointed through the [[Imperial Bourse|bourse]]. It grants the ability to direct research at the [[runeforge]] in [[Redoubt]], located in north-west [[Redoubt#Limus|Limus]] on the road between [[Redoubt#Cargo|Cargo]] and the [[Highguard|Highborn]] town of [[Necropolis#Hedrossan|Hedra]] in [[Necropolis]].

The college allows the creation of new and unique [[magic items]], as well as offering the possibility of sharing that knowledge with Imperial [[Crafting skills#Artisan|artisans]].
...
### Forge Schema
Instead of constructing a single copy of a magic item, the Seer may choose to make a [[Magic items#Schema|schema]]. It takes six months to research a schema, which can require up to 40 materials to create. If the finished item requires more than 40 materials, it requires one extra season of work for every 20 extra materials. Creating a schema requires the Seer of the Spiral Sword to provide one ring of [[ilium]] per ingot or measure of [[materials|material]] required to make the item (to a minimum of 10 rings). A schema is permanent unless destroyed with [[Words of Ending]].
...
### Using the Forge
The runeforge is used during downtime. The Seer of the Spiral Sword should contact Profound Decisions by e-mail (at empire.rules@profounddecisions.co.uk) prior to the next event with the details of the item they wish to try and create. If they want to make a schema, they will need the appropriate number of rings of ilium in their inventory. Profound Decisions will let the player know before the next event the number and type of materials required to make the new item.
...
Custodianship of the runeforge is retained for a year, or until the citizen holding the seat dies, or steps down. An Imperial Bourse seat cannot be [[revocation|revoked]] by the [[Imperial Synod]].
...
Originally designed and built by the Asavean Architect, Almodin Oktístis, and included a number of statues and decorations referencing the false gods of the Asavean religion. Following the Spring Equinox 383YE, the runeforge was subject to an attack by a mob of angry citizens riled up by the Imperial Synod. The statues and mosaics were torn out, smashed, and the remains repurposed to create a small ornamental rock garden a short distance from the forge proper. Fortunately, this coincided with a Senate plan to redesign the works of Almodin Oktístis; while the rune forge experienced a short hiatus it was soon restored to full functionality. These events are covered in more detail [[383YE_Summer_Solstice_winds_of_fortune#Wrecking_Ball|here]].

An extensive library of texts stands in a third building, a fine marble stucture of graceful columns with a pleasent mosaic floor depicting the night sky of the Winter solstice in tempest jade and vibrant coloured tiles that highlight the full moon and constellations. 
...
Around the circumfrence of the chamber are state-of-the-art crafting tools from all major disciplines, each watched over by intricately sculpted stone images of idealised crafters of the appropriate kind.
