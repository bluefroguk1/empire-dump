...
When a Vote of Curtailment is called, the Speaker will conduct a [[Senate motion#Majority Vote|majority vote]]. Those present who are eligible to vote will be asked to vote "Aye" if they wish to close the session early; otherwise the session continues as normal. If the votes passes then the session comes to a premature end. Any motions that have not yet been voted upon are automatically added to the agenda for the following session by the Speaker.
