...
---
stub
You've all fools and briar-brains! This is another sop to them bloody mummers in the mountains, or I'm no brewer. It's [[Folly|folly]] to pass this thing. Them that pay the piper will call the tune.
Walter Brewer, Senator for Upwold
## Overview
Because of the great costs involved in creating a structure using mithril, weirwood, or white granite, most commissions are built to provide important practical benefits. A [[Folly|folly]] is the general term for any [[Commission|commission]] that is explicitly designed ''not'' to provide any apparent benefits.
...
## Senate Commissions
The [[Imperial Senate]] may pass a motion of [[Commission]] for the construction of a [[Folly|folly]]. The senate must select a [[Territory]], and a region within that territory, where the folly will be constructed.
Since the construction of a folly does not provide any tangible benefits, no Imperial title is created to oversee it. It is possible for a senator to create a title to oversee the folly, creating a [[New Imperial titles#Custodian|custodian]] for the folly.
## Scrutiny
...
In theory any [[Commission|commission]] could be manipulated or taken-over by a non-Imperial power, but follies are the most susceptible because they do not have a pre-existing function or purpose.
## Benefits
### Grandeur
...
### Potential Benefits
It is never possible for a folly to provide any tangible benefits while under Imperial control. (If it were possible, then the [[Commission|commission]] would not be a folly).
