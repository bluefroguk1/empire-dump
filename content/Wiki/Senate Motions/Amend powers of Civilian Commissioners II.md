...
### Overview
* This motion was to amend the previous [[Create titles of Civilian Commissioners|motion]] to create the title of [[Civilian Commissioner]] so that the collective ten Civilian Commissioners can only announce up to five constructions per summit
* This motion followed on from a previous [[Amend Powers of Civilian Commissioners|motion]] to amend the powers of the Civilian Commissioners to remove their power to announce the construction of follies
* Passed
### Date
* Autumn 380YE
### Campaign Outcome
