...
- 381YE-Spring
draft: false
Title: Announce targets of the Imperial Guerdon III
aliases:
...
### Overview
* This motion was approved by the [[Quartermaster General of the Imperial Armies]] using the legal power to authorise targets of the [[Military unit#Imperial Guerdon|Imperial Guerdon]] granted to them by the Senate
### Date
* Spring 381YE
### Campaign Outcome
