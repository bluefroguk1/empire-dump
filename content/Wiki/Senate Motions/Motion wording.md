---
revision_id: 96578
revision_date: 2022-11-11T17:35:01Z
Tags:
- Senate-Motion
- Senate
draft: false
...
* Tenure
* Revocation
A motion to [[New Imperial titles|create a new Imperial title]] must specify what legal powers, if any, the title will have authority to use. 
The necessary details include the method of [[New Imperial titles#Appointment|appointment]], to allow civil servants to determine which political house will appoint the position and whether it will be an Imperial or national position. They also need to know the tenure, how long an elected citizen may hold the title before need to be reelected and which assemblies in the [[Imperial Synod]] may revoke a citizen who holds the title.
Many commissions automatically cause the creation of an appropriate Imperial title - for example raising a new Imperial army causes the creation of a new Imperial title for the general of that army. Many of these Imperial titles have long-standing traditional methods of appointment, tenure and revocation. Any new Imperial title that has unusual powers, appointment, tenure, or revocation is likely to be subject to close [[Scrutiny|scrutiny]] by the Constitutional Court.
