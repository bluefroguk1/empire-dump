...
At present Good Walder has no memorial and their grave is unknown. In place of the above options - or as well as one of them - the site could be turned into an inspirational tomb using the normal rules. It would require a dose of True true liao, but if a citizen was given access to that then the tree and/or any shrine could be permanently consecrated to the name of Good Walder (assuming the Prosperity assembly agreed).
