...
Once each debate concludes, the magicians present indicate their support or opposition by raising their [[Urizen_culture_and_customs#Sigil|sigil]] with the issue decided by majority vote. In the case of a tie, then a dictum is considered to have failed to gain the support of the demos. it is not possible to change the wording of a dictum raised to the demos - the vote is always to either support or reject the dictum as written - another reason that brevity and clarity are considered ideal. 
