...
Some mystics use the rune of destiny to represent the labyrinth of ages. These mystics claim that death is the ultimate destiny of all mortals, but the labyrinth represents an ultimate choice. These mystics claim that the soul chooses what form to be reborn in. Some even go so far as to claim that the labyrinth is in fact the ''mortal'' world, and that the path the individual traces through that world is the true purpose of existence.
### Using Gralm in magic
Gralm is rarely used in magic; it is most commonly used in Enchantments designed to [[Empower]] an individual with great power.
===Crafting with Gralm=== 
